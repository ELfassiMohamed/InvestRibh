...
export interface CoverflowSlide {
  ...
  /** Internal route to open when the card is clicked. */
  href?: string;
}
...
export interface CoverflowCarouselProps {
  ...
  /** Overlay the slide title on the card itself. */
...
export function CoverflowCarousel({
  ...
  const onPointerMove = (event: React.PointerEvent<HTMLDivElement>) => {
    ...
    // Capture the pointer only once a real drag begins. Capturing on the
    // pointerdown would retarget the release click at the frame, swallowing
    // taps on the linked cards.
    if (
